export const CartIcon = ({ width = '2.925rem', height = '2.925rem' }) => (
    <svg
        stroke="currentColor"
        fill="currentColor"
        strokeWidth="0"
...
export const SearchIcon = ({ width = '2.925rem', height = '2.925rem' }) => (
    <svg
        stroke="currentColor"
        fill="currentColor"
        strokeWidth="0"
...
export const UserIcon = ({ width = '2.925rem', height = '2.925rem' }) => (
    <svg
        stroke="currentColor"
        fill="currentColor"
        strokeWidth="0"
...
export const LogOutIcon = ({ width = '2.4rem', height = '2.4rem' }) => (
    <svg
        stroke="currentColor"
        fill="currentColor"
        strokeWidth="0"
...
export const FreeShipIcon = ({ width = '3.9rem', height = '3.9rem' }) => (
    <svg
        stroke="currentColor"
        fill="currentColor"
        strokeWidth="0"
...
export const CreditCart = ({ width = '3.9rem', height = '3.9rem' }) => (
    <svg
        stroke="currentColor"
        fill="currentColor"
        strokeWidth="0"
...
export const DiamondIcon = ({ width = '3.9rem', height = '3.9rem' }) => (
    <svg
        stroke="currentColor"
        fill="currentColor"
        strokeWidth="0"
...
export const DonateHeartIcon = ({ width = '3.9rem', height = '3.9rem' }) => (
    <svg
        stroke="currentColor"
        fill="currentColor"
        strokeWidth="0"
...
export const DeleteIcon = ({ width = '1.95rem', height = '1.95rem' }) => (
    <svg
        stroke="currentColor"
        fill="currentColor"
        strokeWidth="0"
...
export const MinusIcon = ({ width = '1.95rem', height = '1.95rem' }) => (
    <svg
        stroke="currentColor"
        fill="currentColor"
        strokeWidth="0"
...
export const PlusIcon = ({ width = '1.95rem', height = '1.95rem' }) => (
    <svg
        stroke="currentColor"
        fill="currentColor"
        strokeWidth="0"
...
export const GoogleIcon = ({ width = '1.82rem', height = '1.82rem' }) => (
    <svg
        height={height}
        width={width}
        fill="currentColor"
...
export const FaceBookIcon = ({ width = '1.95rem', height = '1.95rem' }) => (
    <svg
        height={height}
        width={width}
        fill="currentColor"
...
export const BackBtnIcon = ({ width = '1.82rem', height = '1.82rem' }) => (
    <svg
        stroke="currentColor"
        fill="currentColor"
        strokeWidth="0"
